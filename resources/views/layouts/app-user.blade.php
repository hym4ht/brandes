...
<head>
    ...
    @vite('resources/css/layouts/app-user.css')
...
<body data-turbo-prefetch="true">
    ...
    {{-- Data Sesi untuk Tracking Perubahan Data User --}}
    <meta name="user-updated-at" content="{{ session('user.updated_at') ?? '0' }}">
    ...
    @include('components.c-user.navigation.sidebar')
    ...
    <div class="main-wrap" id="mainWrap">
        ...
        {{-- Navigasi Atas --}}
        @include('components.c-user.navigation.topbar')
