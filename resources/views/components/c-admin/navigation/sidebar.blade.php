...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        {{-- Menu: Dashboard --}}
        <a href="{{ session('user.role') === 'superadmin' ? route('dashboard.superadmin') : route('dashboard.admin') }}"
            class="nav-item {{ request()->routeIs('dashboard.admin') || request()->routeIs('dashboard.superadmin') ? 'active' : '' }}" data-title="Dashboard">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path
        ...
        {{-- Menu: List Admin --}}
        <a href="{{ route('admin.list') }}" class="nav-item {{ request()->routeIs('admin.list') ? 'active' : '' }}"
        ...
        {{-- Menu: List User --}}
        <a href="{{ route('user.list') }}" class="nav-item {{ request()->routeIs('user.list') ? 'active' : '' }}"
        ...
        <a href="{{ route('history.akses') }}"
            class="nav-item {{ request()->routeIs('history.akses') ? 'active' : '' }}" data-title="History Akses">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path
        ...
        {{-- Menu: Log Berkas --}}
        <a href="{{ route('log.berkas') }}" class="nav-item {{ request()->routeIs('log.berkas') ? 'active' : '' }}"
        ...
        <a href="{{ route('lokasi.brankas') }}"
            class="nav-item {{ request()->routeIs('lokasi.brankas') ? 'active' : '' }}" data-title="Lokasi Brankas">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path
