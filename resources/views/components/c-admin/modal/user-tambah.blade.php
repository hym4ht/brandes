{{-- ======================================================================
     ...
     Deskripsi: Digunakan pada halaman list user untuk menambahkan data
                user baru (nama, username, fingerprint ID, pin) ke sistem.
     ====================================================================== --}}
    ...
    <div class="modal modal-tambah">
        ...
        @if(in_array(session('user.role'), ['superadmin', 'admin']))
            <x-c-shared.tooltip-info 
                number="3" 
                title="info 3" 
                text="Super admin & admin menambahkan user melalui form tambah user ini , jadi stand by . nantinya dari sistem IoT user menempelkan sidik jari dan input PIN nya , langsung ke direct kesini" 
                position="left" 
                target=".modal.modal-tambah"
            />
        @endif
            ...
            <div class="tooltip-target-wrapper" style="width: 100%;">
                ...
                @if(in_array(session('user.role'), ['superadmin', 'admin']))
                    <x-c-shared.tooltip-info 
                        number="4" 
                        title="info 4" 
                        text="jika sudah melakukan pengisian data, selanjutnya klik button &quot;simpan&quot;" 
                        position="right" 
                        target="#btnSubmitUser"
                    />
                @endif
            </div>
        </div>
