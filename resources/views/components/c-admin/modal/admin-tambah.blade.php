    ...
    <div class="modal modal-tambah" style="position: relative;">
        ...
        @if(session('user.role') === 'superadmin')
            <x-c-shared.tooltip-info 
                number="3" 
                title="info 3" 
                text="Super admin bisa menambahkan maksimal 2 admin melalui form tambah admin ini" 
                position="left" 
        ...
        @elseif(session('user.role') === 'admin')
            <x-c-shared.tooltip-info 
                number="3" 
                title="info 3" 
                text="admin bisa menambahkan admin baru melalui form tambah admin ini" 
                position="left" 
                target=".modal.modal-tambah"
            />
        @endif
