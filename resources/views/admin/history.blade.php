                ...
                <tbody>
                    ...
                    @foreach($histories as $index => $history)
                        <tr class="data-row">
                            ...
                            <td class="td-nama">
                                <span class="nama-user">{{ $history['nama'] }}</span>
                            </td>
                            <td class="td-aktivitas">{{ $history['aktivitas_bersih'] }}</td>
                            <td class="td-metode">
                                @if($history['fp_id'])
                                    @php
                                    ...
                                    @endphp
                                    {{ $fullId }} {{ str_contains($history['metode'], '+ PIN') ? '+ PIN' : '' }}
                                @else
                                    {{ $history['metode'] }}
                                @endif
                            </td>
                            <td class="td-waktu">
                                <div class="time-column">
                                    <span class="time-main">{{ \Carbon\Carbon::parse($history['waktu'])->format('d M Y') }}</span>
                                    <span class="time-sub">{{ \Carbon\Carbon::parse($history['waktu'])->format('H:i') }} WIB</span>
                                </div>
                            </td>
                            <td class="td-total">
                                <span class="badge-total">{{ $history['total_akses'] }}X</span>
                            </td>
                            <td>
