...
@section('content')
            ...
            <div class="tooltip-target-wrapper">
                ...
                @if(in_array(session('user.role'), ['superadmin', 'admin']))
                    <x-c-shared.tooltip-info 
                        number="1" 
                        title="info 1" 
                        text="super admin & admin bisa melakukan penambahan admin baru" 
                        position="left" 
                    />
                @endif
            </div>
                        ...
                        <tr class="data-row {{ $loop->last ? 'last-row' : '' }}" data-id="{{ $log->id }}">
                            ...
                            <td>
                                <div class="tooltip-target-wrapper" style="display: flex; justify-content: center;">
                                    ...
                                    @if(in_array(session('user.role'), ['superadmin', 'admin']) && $index === 1)
                                        <x-c-shared.tooltip-info 
                                            number="2" 
                                            title="info 2" 
                                            text="super admin & admin bisa melakukan edit dan hapus terhadap data log yang ada" 
                                            position="left" 
                                        />
                                    @endif
                                </div>
    ...
    @push('modals')
        ...
        @include('components.c-shared.delete', ['type' => 'log-berkas'])
    @endpush
