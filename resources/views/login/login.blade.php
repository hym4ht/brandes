...
<head>
    ...
    <style>
        :root {
            --login-bg-image: url('{{ asset("images/bg_form login.png") }}');
        }
    ...
    <div class="right-panel">
        <div class="form-container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="username" name="username" class="form-control"
                                placeholder="Masukan nama anda" value="{{ old('username') }}" required
                                autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper select-wrapper">
                            ...
                            <select id="role" name="role" style="display: none;">
                                <option value="superadmin" {{ (old('role') == 'superadmin' || !old('role')) ? 'selected' : '' }}>Super Admin</option>
            ...
            <div class="form-footer">
                &copy; {{ date('Y') }}. Sistem Monitoring Keamanan Brankas X Universitas Harkat Negeri
            </div>
        </div>
    </div>
