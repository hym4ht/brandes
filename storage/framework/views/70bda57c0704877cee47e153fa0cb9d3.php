...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('dashboard.user')); ?>" class="nav-item <?php echo e(request()->routeIs('dashboard.user') ? 'active' : ''); ?>" data-title="Dashboard">
        ...
        <a href="<?php echo e(route('history.akses')); ?>" class="nav-item <?php echo e(request()->routeIs('history.akses') ? 'active' : ''); ?>" data-title="History Akses">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <a href="<?php echo e(route('user.log.berkas')); ?>" class="nav-item <?php echo e(request()->routeIs('user.log.berkas') ? 'active' : ''); ?>" data-title="Log Berkas">
        ...
        <a href="<?php echo e(route('notifikasi.keamanan')); ?>" class="nav-item <?php echo e(request()->routeIs('notifikasi.keamanan') ? 'active' : ''); ?>" data-title="Notifikasi Sistem">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
        ...
        <a href="<?php echo e(route('user.kredensial')); ?>" class="nav-item <?php echo e(request()->routeIs('user.kredensial') ? 'active' : ''); ?>" data-title="Profile & Kredensial">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
...
</aside><?php /**PATH C:\laragon\www\project - revisi tapi benar (sudah sidang TA)\resources\views/components/c-user/navigation/sidebar.blade.php ENDPATH**/ ?>