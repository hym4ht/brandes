<?php $__env->startSection('title',         'Notifikasi Keamanan'); ?>
<?php $__env->startSection('page_title',    'Notifikasi Keamanan'); ?>
<?php $__env->startSection('page_subtitle', 'Pantau aktivitas mencurigakan dan peringatan keamanan.'); ?>


<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/admin/notifikasi.css', 'resources/css/components/c-shared/security-card.css']); ?>
<?php $__env->stopPush(); ?>
    ...
    <div class="stat-grid">
        ...
        <div class="stat-card">
            <div class="stat-info">
                ...
                <span class="stat-value"><?php echo e($totalNotifikasi); ?></span>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-info">
                ...
                <span class="stat-value"><?php echo e($totalPeringatan); ?></span>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-info">
                ...
                <span class="stat-value"><?php echo e($totalKritis); ?></span>
            </div>
        ...
        <div class="stat-card">
            <div class="stat-info">
                ...
                <span class="stat-value"><?php echo e($totalAkses); ?></span>
            </div>
            <div class="stat-icon green">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="div-toolbar">
        ...
        <div class="toolbar-actions">
            ...
            <div class="calendar-wrapper" style="position: relative;">
                ...
                <?php echo $__env->make('components.c-shared.calendar', ['id' => 'notifCalendarDropdown', 'target' => 'dateFilter'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
...
<?php $__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/admin/notifikasi.js'); ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/restuaja/Downloads/project - revisi tapi benar (sudah sidang TA)/resources/views/admin/notifikasi.blade.php ENDPATH**/ ?>