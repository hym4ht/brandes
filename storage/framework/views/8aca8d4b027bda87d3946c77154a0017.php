    ...
    <div class="user-menu-container">
        ...
        <div class="user-badge" id="userBadge" onclick="toggleUserDropdown(event)">
            <div class="user-avatar">
                <?php echo e(strtoupper(substr(session('user.nama', 'U'), 0, 1))); ?>

            </div>
            <span class="user-name-text">
                <?php echo e(session('user.nama', 'User')); ?>
...
</header><?php /**PATH C:\laragon\www\project - revisi tapi benar (sudah sidang TA)\resources\views/components/c-user/navigation/topbar.blade.php ENDPATH**/ ?>