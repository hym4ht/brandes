...
<div class="modal-overlay" id="userTambahModalOverlay" onclick="closeTambahModalUserOutside(event)">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.c-shared.tooltip-info','data' => ['number' => '3','title' => 'info 3','text' => 'Super admin & admin menambahkan user melalui form tambah user ini , jadi stand by . nantinya dari sistem IoT user menempelkan sidik jari dan input PIN nya , langsung ke direct kesini','position' => 'left','target' => '.modal.modal-tambah']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['number' => '3','title' => 'info 3','text' => 'Super admin & admin menambahkan user melalui form tambah user ini , jadi stand by . nantinya dari sistem IoT user menempelkan sidik jari dan input PIN nya , langsung ke direct kesini','position' => 'left','target' => '.modal.modal-tambah']); ?>
...
<?php endif; ?>
        ...
        <div class="modal-header">
            ...
            <button class="modal-close" onclick="closeTambahModalUser()" title="Tutup Modal">
        ...
        <form action="<?php echo e(route('user.store')); ?>" method="POST" id="addUserForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-inputs-wrapper">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="nama" id="inputNamaLengkap" class="form-control with-icon" placeholder="Masukan nama lengkap user" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="username" class="form-control with-icon" placeholder="Masukan username user" required autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" id="displayFingerprintId" class="form-control with-icon readonly-iot" 
                               placeholder="Data dikirim dari alat" 
                               readonly tabindex="-1">
                        
                        <input type="hidden" name="fingerprint_id" id="hiddenFingerprintId">
                    </div>
                    <p class="form-hint">ID unik akan terisi otomatis setelah Anda mendaftar di alat.</p>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="pin" id="inputUserPin" class="form-control with-icon" placeholder="Data dikirim dari alat" readonly required>
                        <button type="button" class="toggle-eye" id="toggleUserPin" title="Lihat/Sembunyikan PIN">
                    ...
                    <p class="form-hint">PIN ini akan terisi otomatis bersamaan dengan Fingerprint.</p>
                </div>
        ...
        <div class="form-footer">
            <div class="tooltip-target-wrapper" style="width: 100%;">
                <button type="submit" class="btn-submit" id="btnSubmitUser" form="addUserForm">Simpan</button>
                <?php if(in_array(session('user.role'), ['superadmin', 'admin'])): ?>
                    <?php if (isset($component)) { $__componentOriginal1890100d97d52fcea52026969a199468 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal1890100d97d52fcea52026969a199468 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.c-shared.tooltip-info','data' => ['number' => '4','title' => 'info 4','text' => 'jika sudah melakukan pengisian data, selanjutnya klik button &quot;simpan&quot;','position' => 'right','target' => '#btnSubmitUser']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('c-shared.tooltip-info'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['number' => '4','title' => 'info 4','text' => 'jika sudah melakukan pengisian data, selanjutnya klik button &quot;simpan&quot;','position' => 'right','target' => '#btnSubmitUser']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal1890100d97d52fcea52026969a199468)): ?>
<?php $attributes = $__attributesOriginal1890100d97d52fcea52026969a199468; ?>
...
<?php /**PATH /home/restuaja/Downloads/project - revisi tapi benar (sudah sidang TA)/resources/views/components/c-admin/modal/user-tambah.blade.php ENDPATH**/ ?>