...
<div class="modal-overlay admin-edit-overlay" id="adminEditModalOverlay" onclick="window.closeEditModalOutsideAdmin(event)">
    <div class="modal modal-edit">

        
        <div class="modal-header">
            <span class="modal-title">Edit Admin</span>
            <button class="modal-close" onclick="window.closeEditModalAdmin()" title="Tutup Modal">
            ...
            <div class="form-inputs-wrapper">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="nama" id="editNamaAdmin" class="form-control with-icon" placeholder="Masukan Nama" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="username" id="editUsernameAdmin" class="form-control with-icon" placeholder="Masukan Username" required autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="pin" id="editAdminPinInput" class="form-control with-icon" placeholder="Masukan 6 digit PIN" maxlength="6" inputmode="numeric">

                        
                        <button type="button" class="toggle-eye" onclick="window.toggleEditPinAdmin()" title="Tampilkan PIN">
                            <svg id="editEyeIconAdmin" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="form-footer">
            <button type="submit" class="btn-submit" form="editAdminForm">Simpa Perubahan</button>
        </div>

    </div>
</div><?php /**PATH /home/restuaja/Downloads/project - revisi tapi benar (sudah sidang TA)/resources/views/components/c-admin/modal/admin-edit.blade.php ENDPATH**/ ?>