...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('resources/css/layouts/app-user.css'); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')([
        ...
        'resources/css/components/c-user/alert-history.css',
        'resources/css/components/c-user/alert-notifikasi.css',
        'resources/css/components/c-user/alert-kredensial.css',
        'resources/css/components/c-user/detail-dokumen.css'
    ]); ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')([
        ...
        'resources/js/components/c-user/alert.js'
    ]); ?>
</head>
...
<body data-turbo-prefetch="true">
    ...
    <?php echo $__env->make('components.c-user.navigation.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="main-wrap" id="mainWrap">
        ...
        <?php echo $__env->make('components.c-user.navigation.topbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH C:\laragon\www\project - revisi tapi benar (sudah sidang TA)\resources\views/layouts/app-user.blade.php ENDPATH**/ ?>