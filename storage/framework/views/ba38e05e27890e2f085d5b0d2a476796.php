...
<div class="main-status-card <?php echo e($cardClass); ?> <?php echo e($isOffline ? 'is-offline' : ''); ?>" id="brankas-card">
    ...
    <div class="status-header">
        ...
        <div class="live-indicator">
            <span class="dot"></span>
            <span class="live-text" id="live-indicator-text"><?php echo e($isOffline ? 'OFFLINE' : 'LIVE'); ?></span>
        </div>
    </div>
    ...
    <div class="status-body">
        ...
        <div class="status-icon-box" id="brankas-icon-box">
            ...
            <svg class="icon-locked" id="icon-locked" viewBox="0 0 24 24" fill="none"
                style="<?php echo e($isOpen ? 'display: none;' : ''); ?>">
                <path
            ...
            <div class="status-meta-row">
                ...
                <div class="meta-item" id="koneksi-item">
                    <svg id="koneksi-off-icon" viewBox="0 0 24 24" fill="none"
                        style="<?php echo e($isOffline ? '' : 'display: none;'); ?>">
                    ...
                    <span id="koneksi-text">Koneksi IoT: <?php echo e($isOffline ? 'Offline' : 'Online'); ?></span>
                </div>
                ...
                <div class="meta-item" id="monitoring-item">
                    ...
                    <span id="monitoring-text">Monitoring: <?php echo e($isOffline ? 'Non-Aktif' : 'Aktif'); ?></span>
                </div>
...
<?php /**PATH /home/restuaja/Downloads/project - revisi tapi benar (sudah sidang TA)/resources/views/components/c-shared/status-brankas.blade.php ENDPATH**/ ?>